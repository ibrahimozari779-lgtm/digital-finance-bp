...
.ctaBanner{margin:44px 0 8px;padding:38px 32px;border-radius:22px;background:linear-gradient(135deg,#DCE6FB 0%,#0b1a2c 55%,#091524 100%);border:1px solid #234260;display:flex;align-items:center;justify-content:space-between;gap:24px;flex-wrap:wrap}
...
<section class="mHero">
  <div class="reveal in">
    ...
    <div class="ctaRow"><a href="/uygulama" class="primary" style="padding:13px 22px;border-radius:12px">Uygulamayı Ücretsiz Dene</a><a href="/paketler" class="secondary" style="padding:13px 22px;border-radius:12px">Paketleri İncele</a><a href="#video" class="secondary" style="padding:13px 22px;border-radius:12px;display:inline-flex;align-items:center;gap:8px"><span style="display:inline-flex;width:16px;height:16px;border-radius:50%;background:var(--accent);align-items:center;justify-content:center;flex:none"><span style="width:0;height:0;border-top:4px solid transparent;border-bottom:4px solid transparent;border-left:6px solid #fff;margin-left:2px"></span></span>90 saniyede izleyin</a></div>
    <div class="miniTrust">
...
<defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#1D4ED8"/><stop offset="1" stop-color="#4F8CFF"/></linearGradient>
<linearGradient id="g2" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F0F3F8"/><stop offset="1" stop-color="#FFFFFF"/></linearGradient></defs>
<rect x="18" y="30" width="384" height="300" rx="22" fill="url(#g2)" stroke="#E4E8EF"/>
<circle cx="52" cy="58" r="5" fill="#C22A3E"/><circle cx="70" cy="58" r="5" fill="#B4720A"/><circle cx="88" cy="58" r="5" fill="#0E7C66"/>
<g stroke="#E4E8EF"><line x1="40" y1="90" x2="380" y2="90"/></g>
<g>
...
<polyline points="210,240 240,190 270,210 300,150 330,170 360,120" fill="none" stroke="#4F8CFF" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
<circle cx="360" cy="120" r="6" fill="#1D4ED8"/>
<g fill="#33415C" font-family="Inter,sans-serif" font-size="11">
<text x="46" y="292">What</text><text x="82" y="292">Why</text><text x="118" y="292">So What</text><text x="154" y="292">Now What</text>
</g>
<rect x="210" y="110" width="150" height="18" rx="9" fill="#DCE6FB" stroke="#B9CCF0"/>
<text x="220" y="123" fill="#1D4ED8" font-family="Inter,sans-serif" font-size="10" font-weight="700">FINANCIAL HEALTH 84</text>
</svg>
...
(function(){
  ...
  if(_s){ const key=(_s==='1')?'mizan':_s; setTimeout(()=>runSample(key),150); }
})();
